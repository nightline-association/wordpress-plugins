...
- **The code for an IM space on the Three Rings Portal**. For instance, the code for `https://3rportal.org.uk/im/demo` in the URL to your IM space would be `demo`.

### Setting it up
1. Download the latest version of `nla-im-button-embed.zip` from the [**Portal IM Button Embed Plugin**, listed under 'Assets', from the Releases page](https://github.com/ThreeRingsCIC/portal-wordpress-plugins/releases).
...
- **Base URL**: if you're using the Three Rings hosted Portal, you should leave this box blank.
...
**NB:** It is very important to bump version numbers when you have updated a specific plugin.
